...
![CI status](https://github.com/cgngc/go-tcap/actions/workflows/go.yml/badge.svg)
[![golangci-lint](https://github.com/cgngc/go-tcap/actions/workflows/golangci-lint.yml/badge.svg)](https://github.com/cgngc/go-tcap/actions/workflows/golangci-lint.yml)
[![Go Reference](https://pkg.go.dev/badge/github.com/cgngc/go-tcap.svg)](https://pkg.go.dev/github.com/cgngc/go-tcap)
[![GitHub](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/cgngc/go-tcap/blob/master/LICENSE)
...
_If you are looking for a server that just can accept a SCTP/M3UA connection to receive a TCAP packet, [server example in go-m3ua project](https://github.com/cgngc/go-m3ua/blob/master/examples/server/m3ua-server.go) would be a nice choice for you._
...
Yoshiyuki Kurauchi ([Website](https://cgngc.com/))

## LICENSE

[MIT](https://github.com/cgngc/go-tcap/blob/master/LICENSE)
